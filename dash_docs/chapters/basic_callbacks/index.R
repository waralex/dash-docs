...
examples <- list(
  two_inputs=utils$LoadExampleCode('dash_docs/chapters/state/examples/two_inputs.R'),
  one_input_two_states=utils$LoadExampleCode('dash_docs/chapters/state/examples/one_input_two_states.R')
)
