...
examples <- list(
  backendFiltering = utils$LoadExampleCode('dashr/chapters/dashDataTable/part9/examples/backendFiltering.R'),
  frontedFiltering = utils$LoadExampleCode('dashr/chapters/dashDataTable/part9/examples/frontedFiltering.R')
)
...
[DataTable - R Callbacks](/dashDataTable/Part4).
