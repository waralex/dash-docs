...
examples <- list(
  columnDropdowns = utils$LoadExampleCode('dashr/chapters/dashDataTable/part7/examples/columnDropdowns.R'),
  rowDropdowns = utils$LoadExampleCode('dashr/chapters/dashDataTable/part7/examples/rowDropdowns.R')
)
