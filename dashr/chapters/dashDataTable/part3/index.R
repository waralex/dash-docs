...
examples <- list(
  example1 = utils$LoadExampleCode('dashr/chapters/dashDataTable/part3/examples/example1.R'),
  example2 = utils$LoadExampleCode('dashr/chapters/dashDataTable/part3/examples/example2.R')
)
