...
examples <- list(
  backendPaging = utils$LoadExampleCode('dashr/chapters/dashDataTable/part4/examples/backendPaging.R'),
  backendPagingWithSorting = utils$LoadExampleCode('dashr/chapters/dashDataTable/part4/examples/backendPagingWithSorting.R'),
  backendPagingWithMultiSorting = utils$LoadExampleCode('dashr/chapters/dashDataTable/part4/examples/backendPagingWithMultiSorting.R'),
  backendPagingWithFiltering = utils$LoadExampleCode('dashr/chapters/dashDataTable/part4/examples/backendPagingWithFiltering.R'),
  backendPagingWithFilteringMultiSorting = utils$LoadExampleCode('dashr/chapters/dashDataTable/part4/examples/backendPagingWithFilteringMultiSorting.R'),
  filteringSortingwithGraph = utils$LoadExampleCode('dashr/chapters/dashDataTable/part4/examples/filteringSortingwithGraph.R')
)
