...
examples <- list(
  p5e1 = utils$LoadExampleCode('dashr/chapters/dash-cytoscape/events/examples/p5e1.R'),
  p5e2 = utils$LoadExampleCode('dashr/chapters/dash-cytoscape/events/examples/p5e2.R'),
  p5e3 = utils$LoadExampleCode('dashr/chapters/dash-cytoscape/events/examples/p5e3.R')
)
