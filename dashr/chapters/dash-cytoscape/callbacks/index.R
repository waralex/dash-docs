...
examples <- list(
  p4e1 = utils$LoadExampleCode('dashr/chapters/dash-cytoscape/callbacks/examples/p4e1.R'),
  p4e2 = utils$LoadExampleCode('dashr/chapters/dash-cytoscape/callbacks/examples/p4e2.R'),
  p4e3 = utils$LoadExampleCode('dashr/chapters/dash-cytoscape/callbacks/examples/p4e3.R')
)
