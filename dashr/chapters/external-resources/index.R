...
examples <- list(
  ...
  folderHost = utils$LoadExampleCode('dashr/chapters/external-resources/examples/folderHost.R'),
  embeddingImages = utils$LoadExampleCode('dashr/chapters/external-resources/examples/embeddingImages.R'),
  addingExternalCSS = utils$LoadExampleCode('dashr/chapters/external-resources/examples/addingExternalCSS.R'),
