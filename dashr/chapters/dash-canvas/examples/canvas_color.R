...
app$layout(htmlDiv(list(
  ...
  htmlDiv(dashCanvas(id='canvas-color', width=canvas_width, filename=filename, hide_buttons=list('line', 'zoom', 'pan')), className='six columns')
  ,
  htmlDiv(list(
    
    htmlH6(children='Brush width')
    ,
    dccSlider(id='bg-width-slider', min=2, max=40, step=1, value=5)
    ,
