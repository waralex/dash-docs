...
examples <- list(
  confirmdialogue = utils$LoadExampleCode('dashr/chapters/dash-core-components/ConfirmDialog/examples/confirm.R'),
  confirmdialogueproptable = utils$LoadExampleCode('dashr/chapters/dash-core-components/ConfirmDialog/examples/confirmdialogproptable.R')
)
