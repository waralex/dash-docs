...
examples <- list(
  pickerrange  =  utils$LoadExampleCode('dashr/chapters/dash-core-components/DatePickerRange/examples/datepickerrange.R'),
  datepickerrangeproptable = utils$LoadExampleCode('dashr/chapters/dash-core-components/DatePickerRange/examples/datepickerrangeproptable.R')
)
