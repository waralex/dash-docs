...
examples <- list(
  ...
  tabinline2 = utils$LoadExampleCode('dashr/chapters/dash-core-components/Tabs/examples/tabsinline2.R'),
  tabproptable = utils$LoadExampleCode('dashr/chapters/dash-core-components/Tabs/examples/tabproptable.R'),
  tabsproptable = utils$LoadExampleCode('dashr/chapters/dash-core-components/Tabs/examples/tabsproptable.R')
)
