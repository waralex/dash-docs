...
examples <- list(
  simpledate = utils$LoadExampleCode('dashr/chapters/dash-core-components/DatePickerSingle/examples/simpleDateSingle.R'),
  datepickerproptable = utils$LoadExampleCode('dashr/chapters/dash-core-components/DatePickerSingle/examples/datepickerproptable.R')
)
