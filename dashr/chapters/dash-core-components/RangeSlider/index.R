...
examples <- list(
  rangeslider1 = utils$LoadExampleCode('dashr/chapters/dash-core-components/RangeSlider/examples/rangeslider1.R'),
  rangeslidernonlinear = utils$LoadExampleCode('dashr/chapters/dash-core-components/RangeSlider/examples/rangeslidernonlinear.R'),
  rangesliderproptable = utils$LoadExampleCode('dashr/chapters/dash-core-components/RangeSlider/examples/rangesliderproptable.R')
)
