...
examples <- list(
  uploadcomp = utils$LoadExampleCode('dashr/chapters/dash-core-components/UploadComponent/examples/uploadcomp.R'),
  uploadcomp3 = utils$LoadExampleCode('dashr/chapters/dash-core-components/UploadComponent/examples/uploadcomp3.R'),
  uploadcomp2 = utils$LoadExampleCode('dashr/chapters/dash-core-components/UploadComponent/examples/uploadcomp2.R'),
  uploadproptable = utils$LoadExampleCode('dashr/chapters/dash-core-components/UploadComponent/examples/uploadproptable.R')
)
