...
examples <- list(
  graph = utils$LoadExampleCode('dashr/chapters/dash-core-components/Graph/examples/graphexample.R'),
  graphproptable = utils$LoadExampleCode('dashr/chapters/dash-core-components/Graph/examples/graphproptable.R')
)
