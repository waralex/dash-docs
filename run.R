...
source('dash_docs/chapters/callbacks/index.R', local=chapters.callbacks)
chapters.state <- new.env()
source('dash_docs/chapters/basic_callbacks/index.R', local=chapters.state)
...
source('dash_docs/chapters/dash_core_components/UploadComponent/index.R', local=chapters.UploadComponent)
...
source('dash_docs/chapters/dash_core_components/LoadingComponent/index.R', local=chapters.LoadingComponent)
...
source('dash_docs/chapters/dash_daq/boolean_switch/booleanswitch.R', local = chapters.booleanswitch)
chapters.colorpicker <- new.env()
source('dash_docs/chapters/dash_daq/color_picker/colorpicker.R', local = chapters.colorpicker)
chapters.gauge <- new.env()
source('dash_docs/chapters/dash_daq/gauge/gauge.R', local = chapters.gauge)
chapters.graduatedbar <- new.env()
source('dash_docs/chapters/dash_daq/graduated_bar/graduatedbar.R', local = chapters.graduatedbar)
...
source('dash_docs/chapters/dash_daq/led_display/leddisplay.R', local = chapters.leddisplay)
chapters.numericinput <- new.env()
source('dash_docs/chapters/dash_daq/numeric_input/numericinput.R', local = chapters.numericinput)
chapters.powerbutton <- new.env()
source('dash_docs/chapters/dash_daq/power_button/powerbutton.R', local = chapters.powerbutton)
chapters.precisioninput <- new.env()
source('dash_docs/chapters/dash_daq/precision_input/precisioninput.R', local = chapters.precisioninput)
...
source('dash_docs/chapters/dash_daq/stop_button/stopbutton.R', local = chapters.stopbutton)
...
source('dash_docs/chapters/dash_daq/toggle_switch/toggleswitch.R', local = chapters.toggleswitch)
chapters.darkthemeprovider <- new.env()
source('dash_docs/chapters/dash_daq/dark_theme_provider/darkthemeprovider.R', local = chapters.darkthemeprovider)
...
source('dash_docs/chapters/dash_bio/alignment_chart/alignment_chart.R', local=chapters.alignment)
...
source('dash_docs/chapters/search/index.R', local=chapters.search)
