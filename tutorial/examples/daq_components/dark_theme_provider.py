...
rootLayout = html.Div(
    [
        daq.BooleanSwitch(
            on=True, id="darktheme-daq-booleanswitch", className="dark-theme-control"
        ),
        html.Br(),
        daq.ToggleSwitch(
            id="darktheme-daq-toggleswitch", className="dark-theme-control"
        ),
        html.Br(),
        daq.ColorPicker(
            value=17, id="darktheme-daq-colorpicker", className="dark-theme-control"
        ),
        html.Br(),
        daq.Gauge(
            min=0,
        ...
        html.Br(),
        daq.StopButton(id="darktheme-daq-stopbutton", className="dark-theme-control"),
        html.Br(),
        daq.Slider(
            min=0,
            max=100,
...
app.layout = html.Div(
    ...
    children=[
        ...
        html.Div(
            ...
            children=[
                daq.ColorPicker(
                    id="primary-color", label="Primary color", value=dict(hex="#00EA64")
                ),
                daq.ColorPicker(
                    id="secondary-color",
                    label="Accent color",
                ...
                daq.ColorPicker(
                    id="detail-color", label="Detail color", value=dict(hex="#007439")
                ),
            ],
        ),
        html.Div(
