...
LocalDir = html.Div(children=[
    ...
    ***
    ...
    file_pathname = os.path.abspath(os.path.join('data', 'my-dataset.csv'))"""),
    customStyle=styles.code_container,
    language='python'
    ),
...
"""if 'DASH_APP' in os.environ:
    ...
    filepath = os.path.abspath(os.path.join('data', 'my-dataset.csv'))
else:
    # local file path
    filepath = os.path.abspath(os.path.join('Users', 'chris', 'data', 'my-dataset.csv'))""",
    customStyle=styles.code_container,
    language='python'
    ),
