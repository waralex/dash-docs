...
def layout(lang='en'):
    ...
    layout.append(dcc.SyntaxHighlighter('''pip install dash=={}  # The core dash backend
    ...
    if lang == 'en':
        ...
        layout.extend([
            Syntax(examples[0][0], summary='''
                始めに、次のコードを使って `app.py`という名前のファイルを作成してください：
            ''')
        ])


    layout.extend([dcc.Markdown('''
        Run the app with
