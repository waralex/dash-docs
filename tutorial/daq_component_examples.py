...
examples = {
    "boolean-switch": tools.load_example(
        "tutorial/examples/daq_components/boolean_switch.py"
    ),
    "color-picker": tools.load_example(
        "tutorial/examples/daq_components/color_picker.py"
    ),
    "gauge": tools.load_example("tutorial/examples/daq_components/gauge.py"),
    "graduated-bar": tools.load_example(
        "tutorial/examples/daq_components/graduated_bar.py"
    ),
    ...
    "LED-display": tools.load_example(
        "tutorial/examples/daq_components/LED_display.py"
    ),
    "numeric-input": tools.load_example(
        "tutorial/examples/daq_components/numeric_input.py"
    ),
    "power-button": tools.load_example(
        "tutorial/examples/daq_components/power_button.py"
    ),
    "precision-input": tools.load_example(
        "tutorial/examples/daq_components/precision_input.py"
    ),
    "stop-button": tools.load_example(
        "tutorial/examples/daq_components/stop_button.py"
    ),
    ...
    "thermometer": tools.load_example(
        "tutorial/examples/daq_components/thermometer.py"
    ),
    "toggle-switch": tools.load_example(
        "tutorial/examples/daq_components/toggle_switch.py"
    ),
    "dark-theme-provider": tools.load_example(
        "tutorial/examples/daq_components/dark_theme_provider.py"
    ),
...
# BooleanSwitch
BooleanSwitch = html.Div(
    children=[
        html.H1("Boolean Switch Examples and Reference"),
        html.Hr(),
        html.H3("Default Boolean Switch"),
        html.P(
            "An example of a default boolean switch without \
            any extra properties."
        ),
        dcc.SyntaxHighlighter(
            examples["boolean-switch"][0], customStyle=styles.code_container
        ),
        html.Div(
        ...
        html.H3("Color"),
        dcc.Markdown(
            "Set the color of the boolean switch with \
    `color=#<hex_value>`."
        ),
        ComponentBlock(
...
ColorPicker = html.Div(
    children=[
        ...
        html.P(
            "An example of a default Color Picker without \
            any extra properties."
        ),
        dcc.SyntaxHighlighter(
            examples["color-picker"][0], customStyle=styles.code_container
        ),
        html.Div(
...
daq.ColorPicker(
  ...
  size=164,
        ...
        html.H3("Label"),
        dcc.Markdown(
            "Define the label and label position using the `label` and `labelPosition` \
    properties."
        ),
        ComponentBlock(
            """import dash_daq as daq
...
Gauge = html.Div(
    children=[
        ...
        html.P(
            "An example of a default Gauge without \
            any extra properties."
        ),
        dcc.SyntaxHighlighter(examples["gauge"][0], customStyle=styles.code_container),
        html.Div(
            examples["gauge"][1],
            className="example-container",
            style={"overflow-x": "initial"},
...
# Graduated Bar
GraduatedBar = html.Div(
    children=[
        html.H1("Graduated bar Examples and Reference"),
        html.Hr(),
        html.H3("Default Graduated bar"),
        dcc.Markdown(
            "An example of a default Graduated bar without \
            any extra properties."
        ),
        dcc.SyntaxHighlighter(
            examples["graduated-bar"][0], customStyle=styles.code_container
        ),
        html.Div(
...
Indicator = html.Div(
    children=[
        ...
        dcc.Markdown(
            "An example of a default Indicator without \
        any extra properties."
        ),
        dcc.SyntaxHighlighter(
            examples["indicator"][0], customStyle=styles.code_container
        ),
        html.Div(
...
daq.Indicator(
  ...
  value=False
        ...
        html.H3("Square"),
        dcc.Markdown(
            "Create a square boolean indicator by setting the \
...
Joystick = html.Div(
    children=[
        ...
        dcc.Markdown(
            "An example of a default Joystick without \
    any extra properties."
        ),
        dcc.SyntaxHighlighter(
            examples["joystick"][0], customStyle=styles.code_container
        ),
        html.Div(examples["joystick"][1], style={"overflow=x": "initial"}),
        html.Hr(),
        html.H3("Label"),
        dcc.Markdown(
...
daq.Joystick(
  ...
  labelPosition="bottom"
        ...
        html.Hr(),
        html.H3("Size"),
        dcc.Markdown("Change the size of the joystick with `size`."),
        ComponentBlock(
            """import dash_daq as daq
...
Knob = html.Div(
    children=[
        ...
        dcc.Markdown(
            "An example of a default Knob without \
            any extra properties."
        ),
        dcc.SyntaxHighlighter(examples["knob"][0], customStyle=styles.code_container),
        html.Div(
            examples["knob"][1],
            className="example-container",
            style={"overflow-x": "initial"},
...
daq.Knob(
  ...
  color={"gradient":True,"ranges":{"green":[0,5],"yellow":[5,9],"red":[9,10]}}
        ...
        html.H3("Scale"),
        dcc.Markdown(
            "Adjust the scale interval, label interval, \
...
LEDDisplay = html.Div(
    children=[
        ...
        dcc.Markdown(
            "An example of a default LED display without \
            any extra properties."
        ),
        dcc.SyntaxHighlighter(
            examples["LED-display"][0], customStyle=styles.code_container
        ),
        html.Div(
...
# Numeric Input
NumericInput = html.Div(
    children=[
        html.H1("Numeric Input Examples and Reference"),
        html.Hr(),
        html.H3("Default Numeric Input"),
        dcc.Markdown(
            "An example of a default numeric input without \
            any extra properties."
        ),
        dcc.SyntaxHighlighter(
            examples["numeric-input"][0], customStyle=styles.code_container
        ),
        html.Div(
...
PowerButton = html.Div(
    children=[
        ...
        dcc.Markdown(
            "An example of a default power button without \
            any extra properties."
        ),
        dcc.SyntaxHighlighter(
            examples["power-button"][0], customStyle=styles.code_container
        ),
        html.Div(
...
# Precision Input
PrecisionInput = html.Div(
    children=[
        html.H1("Precision Input Examples and Reference"),
        html.Hr(),
        html.H3("Default Precision Input"),
        dcc.Markdown(
            "An example of a default precision input without \
            any extra properties."
        ),
        dcc.SyntaxHighlighter(
            examples["precision-input"][0], customStyle=styles.code_container
        ),
        html.Div(
...
StopButton = html.Div(
    children=[
        ...
        dcc.Markdown(
            "An example of a default stop button without \
            any extra properties."
        ),
        dcc.SyntaxHighlighter(
            examples["stop-button"][0], customStyle=styles.code_container
        ),
        html.Div(
...
Slider = html.Div(
    children=[
        ...
        dcc.Markdown(
            "An example of a default slider without \
            any extra properties."
        ),
        dcc.SyntaxHighlighter(examples["slider"][0], customStyle=styles.code_container),
        html.Div(
            examples["slider"][1],
            className="example-container",
            style={"overflow-x": "initial"},
...
Tank = html.Div(
    children=[
        ...
        dcc.Markdown(
            "An example of a default tank without \
            any extra properties."
        ),
        dcc.SyntaxHighlighter(examples["tank"][0], customStyle=styles.code_container),
        html.Div(
            examples["tank"][1],
            className="example-container",
            style={"overflow-x": "initial"},
        ...
        dcc.Markdown(
            "Display the current value, along with optional \
...
""",
        ...
        html.H3("Label"),
        dcc.Markdown(
            "Display a label alongside your tank in the \
...
Thermometer = html.Div(
    children=[
        ...
        dcc.Markdown(
            "An example of a default Thermometer without \
            any extra properties."
        ),
        dcc.SyntaxHighlighter(
            examples["thermometer"][0], customStyle=styles.code_container
        ),
        html.Div(
...
# Toggle Switch
ToggleSwitch = html.Div(
    children=[
        html.H1("Toggle Switch Examples and Reference"),
        html.Hr(),
        html.H3("Default Toggle Switch"),
        dcc.Markdown(
            "An example of a default toggle switch without \
            any extra properties."
        ),
        dcc.SyntaxHighlighter(
            examples["toggle-switch"][0], customStyle=styles.code_container
        ),
        html.Div(
...
daq.ToggleSwitch(
    size=100
        ...
        html.H3("Label"),
        dcc.Markdown(
            "Add a label to the toggle switch and specify \
...
# Dark Theme Provider
DarkThemeProvider = html.Div(
    children=[
        html.H1("Dark Theme Provider Examples and Reference"),
        html.Hr(),
        html.H3("Default Dark Theme Provider"),
        dcc.Markdown(
            "An example of a default dark theme provider without \
            any extra properties."
        ),
        dcc.SyntaxHighlighter(
            examples["dark-theme-provider"][0], customStyle=styles.code_container
        ),
        html.Div(
